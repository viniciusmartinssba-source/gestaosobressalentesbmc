...
import { t as supabase } from "./client-wU3s2XP8.mjs";
import { u as require_react } from "../_libs/@floating-ui/react-dom+[...].mjs";
import { o as require_jsx_runtime } from "../_libs/@radix-ui/react-collection+[...].mjs";
import { a as useAuth, n as createSsrRpc } from "./data.functions-DdHw2GTu.mjs";
...
import { C as ChartColumn, E as Boxes, S as Check, T as Calendar, _ as FileDown, a as TrendingUp, b as ChevronUp, c as Search, d as Pencil, f as Package, g as LayoutDashboard, i as TriangleAlert, l as RotateCcwClock, m as LogOut, o as Trash, p as Menu, s as Sparkles, t as X, u as RefreshCw, v as CirclePlus, w as Camera, x as ChevronDown, y as CircleCheck } from "../_libs/lucide-react.mjs";
import { t as Route } from "./routes-vgg-F9z2.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-rIRrNi7G.js
...
}).parse(data)).handler(createSsrRpc("88339309d2b23343f28f1a0637cdfd5dd541475747f99b1c0834dd25f1a449a0"));
...
}).parse(data)).handler(createSsrRpc("4bf7302696455a8a83c5e45226bb8b13abb77b4171c8c5793a090aee59254c50"));
/** Exclusão de um lançamento (somente admin, garantido por RLS). */
var deleteMovimentacao = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).inputValidator((data) => objectType({ id: stringType().uuid() }).parse(data)).handler(createSsrRpc("3449d09ae6e3dcce870286f7af9d51b83017256c19e7a03ce9e166087ecf9e49"));
/** Geração de insights por IA com base nas retiradas registradas. */
var generateInsights = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).handler(createSsrRpc("1c64b5260d4652aaa90293b5428727a77c5bf10b8b533dd6fe4f443e9ee6dfdc"));
...
var exportToPDF = (data) => {
	const doc = new import_jspdf_node_min.jsPDF({ orientation: "landscape" });
	...
	const drawHeader = () => {
		...
		doc.text(`Gerado em ${format(/* @__PURE__ */ new Date(), "dd/MM/yyyy 'às' HH:mm")}  •  ${data.length} registros`, pageWidth - 14, 23, { align: "right" });
	};
...
var exportToXLSX = (data) => {
	const dark = "FF0F172A";
	const darkSoft = "FF1E293B";
	const primary = "FF0369A1";
	const primaryLight = "FF38BDF8";
	...
	const bodyCell = (alt, align, bold = false, color = dark) => ({
		font: {
			sz: 11,
			bold,
			color: { rgb: color },
	...
	for (let c = 0; c < totalCols; c++) ws[import_xlsx_min.utils.encode_cell({
		r: totalRowIdx,
		c
	})] = {
	...
	ws["!autofilter"] = { ref: import_xlsx_min.utils.encode_range({
		s: {
			r: 2,
			c: 0
		},
...
function Dashboard() {
	...
	const [novoSap, setNovoSap] = (0, import_react.useState)("");
	const [novaDescricao, setNovaDescricao] = (0, import_react.useState)("");
	const [isSavingMaterial, setIsSavingMaterial] = (0, import_react.useState)(false);
	const [insights, setInsights] = (0, import_react.useState)("");
	const [isGeneratingInsights, setIsGeneratingInsights] = (0, import_react.useState)(false);
	const [editing, setEditing] = (0, import_react.useState)(null);
	const [isSavingEdit, setIsSavingEdit] = (0, import_react.useState)(false);
	...
	const [dataRetirada, setDataRetirada] = (0, import_react.useState)("");
	...
	const openEdit = (item) => {
		...
		const iso = item.dataISO ? new Date(item.dataISO) : /* @__PURE__ */ new Date();
	...
	const criticalParts = (0, import_react.useMemo)(() => {
		const counts = {};
		history.forEach((h) => {
			const entry = counts[h.sap] || {
				sap: h.sap,
				peca: h.peca,
				total: 0
			};
	...
	const stats = (0, import_react.useMemo)(() => {
		...
		const countToday = history.filter((h) => new Date(h.dataISO || Date.now()).getTime() >= today.getTime()).length;
		const countMonth = history.filter((h) => new Date(h.dataISO || Date.now()).getTime() >= startOfMonth.getTime()).length;
	...
	const todayChartData = (0, import_react.useMemo)(() => {
		const start = /* @__PURE__ */ new Date();
		start.setHours(0, 0, 0, 0);
		const buckets = {};
		history.filter((h) => new Date(h.dataISO || Date.now()).getTime() >= start.getTime()).forEach((h) => {
	...
	const pieData = (0, import_react.useMemo)(() => criticalParts.slice(0, 4).map((p) => ({
		name: p.peca,
		value: p.total
	})), [criticalParts]);
	...
	if (isAuthLoading || isAuthenticated && !user) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", {
						...
						children: [
							...
							isAdmin && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								className: cn("flex items-center gap-3 w-full px-4 py-3 rounded-xl transition-all duration-200 group cursor-pointer", activeTab === "material" ? "bg-primary text-primary-foreground font-bold shadow-md shadow-primary/20 scale-[1.02]" : "text-sidebar-foreground/60 hover:bg-sidebar-accent/50 hover:text-sidebar-foreground hover:scale-[1.01]"),
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								className: cn("flex items-center gap-3 w-full px-4 py-3 rounded-xl transition-all duration-200 group cursor-pointer", activeTab === "ia" ? "bg-primary text-primary-foreground font-bold shadow-md shadow-primary/20 scale-[1.02]" : "text-sidebar-foreground/60 hover:bg-sidebar-accent/50 hover:text-sidebar-foreground hover:scale-[1.01]"),
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sparkles, {
									size: 20,
									className: "transition-transform group-hover:scale-110"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "text-sm",
									children: "Insights por IA"
								})]
							})
						]
					}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", {
										...
										children: [
											...
											isAdmin && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
												...
												className: cn("flex items-center gap-3 w-full px-4 py-3 rounded-xl transition-all", activeTab === "material" ? "bg-accent text-accent-foreground font-medium" : "text-muted-foreground hover:bg-accent/50"),
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Boxes, { size: 20 }), " Novo Material"]
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
												onClick: () => {
													setActiveTab("ia");
												...
												className: cn("flex items-center gap-3 w-full px-4 py-3 rounded-xl transition-all", activeTab === "ia" ? "bg-accent text-accent-foreground font-medium" : "text-muted-foreground hover:bg-accent/50"),
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sparkles, { size: 20 }), " Insights por IA"]
											})
										]
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						activeTab === "overview" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "pointer-events-none absolute inset-0 bg-gradient-to-r from-primary/5 to-transparent opacity-50" }),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
											className: "rounded-3xl border-border shadow-none p-6 bg-card/50 backdrop-blur-sm lg:col-span-2",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
												className: "p-0 pb-6",
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardTitle, {
													className: "text-lg font-bold",
													children: "Retiradas de Hoje"
												}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardDescription, { children: "Quantidade de peças retiradas por horário no dia de hoje" })]
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardContent, {
												className: "h-[280px] p-0",
												children: todayChartData.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
													className: "h-full flex items-center justify-center text-sm text-muted-foreground",
													children: "Nenhuma retirada registrada hoje."
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardTitle, {
													className: "text-lg font-bold",
													children: "Peças Críticas"
												}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardDescription, { children: "Peças com maior acúmulo de retiradas" })]
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardContent, {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "space-y-2",
											children: [
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { children: "Data e Hora da Retirada (Opcional)" }),
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
													type: "datetime-local",
													value: dataRetirada,
												...
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
													className: "text-xs text-muted-foreground",
													children: "Se deixar em branco, será registrado o horário da confirmação da retirada."
												})
											]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						activeTab === "history" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableBody, { children: history.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TableRow, {
										className: "group",
										children: [
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
										...
										onClick: () => setActiveTab("material"),
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Boxes, { size: 18 }), " Novo Material"]
									})
								})]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, {
								className: "border-none shadow-sm shadow-border bg-card text-card-foreground",
						...
						activeTab === "material" && isAdmin && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "max-w-2xl mx-auto animate-in fade-in duration-300",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
								className: "border-none shadow-md shadow-border overflow-hidden rounded-2xl bg-card text-card-foreground",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
									className: "bg-primary text-primary-foreground",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardTitle, { children: "Cadastrar Novo Material" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardDescription, {
										className: "text-primary-foreground/80",
										children: "Adicione ao catálogo uma peça recém-cadastrada no almoxarifado."
									})]
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
									className: "space-y-6 pt-6",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "space-y-2",
											children: [
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Label, { children: ["Código SAP ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
													className: "text-destructive",
													children: "*"
												})] }),
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
												...
												novoSap && data.catalogo.some((p) => p.sap === novoSap) && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
													className: "text-xs text-amber-500 font-medium",
													children: "Este código já existe no catálogo e será atualizado."
												})
											]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "space-y-2",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Label, { children: ["Descrição do Material ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												className: "text-destructive",
												children: "*"
											})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
												value: novaDescricao,
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
											...
											children: [
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Boxes, { size: 20 }),
												" ",
												isSavingMaterial ? "Salvando..." : "Salvar no Catálogo"
											]
										})
									]
								})]
						...
						activeTab === "ia" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "space-y-6 animate-in fade-in duration-300",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
									...
									className: "text-sm text-muted-foreground",
									children: "Análise automática das retiradas registradas no sistema."
								})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
								...
								className: "rounded-3xl border-border bg-card/50 backdrop-blur-sm p-6",
								children: isGeneratingInsights ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-sm text-muted-foreground animate-pulse",
									children: "A IA está analisando as movimentações. Isso pode levar alguns instantes..."
								}) : insights ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "whitespace-pre-wrap text-sm leading-relaxed text-foreground",
									children: insights
								}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-sm text-muted-foreground",
									children: "Clique em \"Gerar Insights\" para que a IA analise as retiradas e aponte peças críticas, tendências e recomendações de reposição."
								})
							})]
						}),
						editing && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
								className: "w-full max-w-lg rounded-3xl overflow-hidden border-none shadow-2xl",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
									className: "bg-primary text-primary-foreground p-6 flex-row items-center justify-between",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardTitle, {
										className: "text-xl",
										children: "Editar Lançamento"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
										variant: "ghost",
										size: "icon",
									...
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "space-y-2",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { children: "Parque Eólico" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "space-y-2",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { children: "Aerogerador" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
												value: editing.aero,
												onValueChange: (val) => setEditing({
													...editing,
													aero: val
												}),
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, {
													className: "h-12 rounded-xl bg-slate-50 text-black",
													children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectValue, {})
												}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectContent, { children: (data.parques.find((p) => p.id === editing.parque_id)?.aeros ?? []).map((a) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SelectItem, {
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "space-y-2",
											children: [
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { children: "Código SAP" }),
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
													value: editing.sap,
													onChange: (e) => setEditing({
														...editing,
														sap: e.target.value.trim()
													}),
													className: "h-12 rounded-xl bg-slate-50 text-black font-mono"
												}),
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
													className: "text-xs text-muted-foreground",
													children: data.catalogo.find((p) => p.sap === editing.sap)?.descricao || "Código não encontrado no catálogo."
												})
											]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												className: "space-y-2",
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { children: "Work Order" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
													value: editing.wo,
													onChange: (e) => setEditing({
														...editing,
														wo: e.target.value
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "space-y-2",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { children: "Data e Hora" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
												type: "datetime-local",
												value: editing.data,
												onChange: (e) => setEditing({
													...editing,
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
												...
												children: isSavingEdit ? "Salvando..." : "Salvar Alterações"
											})]
										})
									]
								})]
