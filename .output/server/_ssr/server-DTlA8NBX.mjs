import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-DkEF2aAy.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BUmUvvfQ.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DB-DVvQW.mjs"),
		import("./start-BPlm26V5.mjs"),
